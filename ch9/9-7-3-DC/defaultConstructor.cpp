...
int main(int argc,char *argv[]){
  try{
    Date oneDefaultDay;
    std::cout<<oneDefaultDay.year()<<"/"<<oneDefaultDay.month()<<"/"<<oneDefaultDay.day()<<"\n";
     Date anotherDefaultDay;
    std::cout<<anotherDefaultDay.year()<<"/"<<anotherDefaultDay.month()<<"/"<<anotherDefaultDay.day()<<"\n";
