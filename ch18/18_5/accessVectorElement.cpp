...
void ff(const vector& v1,vector& v2){
  double x = v1[2];
  /*
    The below line will generates error by invoking the 
    overloded operator [](size_t i)const because the 
    object passed in as a constant
  */
  //v1[3] = 5.0;
  double y = v2[5];
  v2[5] = 77.0;
...
int main(int argc,char** argv){
  ...
  vector v1(10,1);
  vector v2(10,2);
  std::cout<<"\nBefore calling ff(const vector& v1,vector& v2)\n\n";
  ff(v1,v2);
  return 0;
}
